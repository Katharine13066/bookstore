...
@Table(name = "BOOKSTORE_PURCHASE_ORDER")
@Entity(name = "bookstore$PurchaseOrder")
@Listeners("thesis_DocEntityListener")
@EnableRestore
@TrackEditScreenHistory
@PrimaryKeyJoinColumn(name = "CARD_ID", referencedColumnName = "ID")
public class PurchaseOrder extends Doc implements HasDetailedDescription {

    private static final long serialVersionUID = -5126548673120023903L;
