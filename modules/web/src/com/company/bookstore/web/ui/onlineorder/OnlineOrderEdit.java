...
package com.company.bookstore.web.ui.onlineorder;
...
public class OnlineOrderEdit<T extends OnlineOrder> extends AbstractCardEditor<T> {
    ...
    protected void initHeaderFragmentContent(CardHeaderFragment cardHeaderFragment) {
        cardHeaderFragment.addDetailsInfoItem(
            "numberCaption",
            messages.getMessage(OnlineOrder.class, "notification.number"),
            "numberValue",
            cardDs,
            "number"
        );
        cardHeaderFragment.addDetailsInfoItem(
            "dateCaption",
            messages.getMessage(OnlineOrder.class, "notification.from"),
            "dateValue",
            cardDs,
            "createTs",
