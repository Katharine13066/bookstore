...
public class BookstoreTestContainer extends ThesisTestContainer {

    public BookstoreTestContainer() {
        super();
        // project and special properties for test environment.
        appPropertiesFiles.add("bookstore-app.properties");
        appPropertiesFiles.add("bookstore-test-app.properties");
