package com.company.bookstore.core.app;
...
@Component("bookstore_ExtDeployer")
public class ExtDeployer extends AbstractDeployer implements ExtDeployerMBean {
        ...
        try {
            ...
            String initDefaultInFirstStart = em.createQuery(
                    "select c.value from sys$Config c " +
                            "where c.name='bookstore.initDefaultInFirstStart'",
                ...
                if (StringUtils.isNotBlank(edition) && Integer.parseInt(edition) > 1) {
                    ...
                    if (initDefaultInFirstStart == null) {
                        try {
                            ...
                            config.setName("bookstore.initDefaultInFirstStart");
                        ...
                        try {
                            authentication.begin();
                            em.createQuery("update sys$Config c set c.value='false' where c.name='bookstore.initDefaultInFirstStart'",
    ...
    protected void executeInitScripts() {
        ...
        File folderDB = new File(dbDirPath + "/50-bookstore/init/" + dbmsType);
