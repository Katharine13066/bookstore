...
package com.company.bookstore.core.listener;
...
import com.company.bookstore.entity.OnlineOrder;
import org.springframework.stereotype.Component;

@Component(OnlineOrderListener.NAME)
public class OnlineOrderListener<T extends OnlineOrder> implements BeforeUpdateEntityListener<T>, BeforeInsertEntityListener<T> {
    public static final String NAME = "bookstore_OnlineOrderListener";
